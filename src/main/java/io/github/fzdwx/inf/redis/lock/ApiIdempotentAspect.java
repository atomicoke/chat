package io.github.fzdwx.inf.redis.lock;

import cn.hutool.crypto.SecureUtil;
import io.github.fzdwx.inf.exc.ForbiddenException;
import io.github.fzdwx.inf.exc.VerifyException;
import io.github.fzdwx.inf.util.SpElUtil;
import io.github.fzdwx.inf.util.SpringAspectUtil;
...
public class ApiIdempotentAspect {
     ...
     * 接口幂等切面
     */
    @Around("@annotation(ApiIdempotent)||" +
            "@within(ApiIdempotent)")
