package org.atomicoke.inf.middleware.redis.lock;
...
import org.atomicoke.inf.common.util.SpElUtil;
import org.atomicoke.inf.common.util.SpringAspectUtil;
...
public class ApiIdempotentAspect {
     ...
     * 接口幂等切面
     */
    @Around("@annotation(org.atomicoke.inf.middleware.redis.lock.ApiIdempotent)||" +
            "@within(org.atomicoke.inf.middleware.redis.lock.ApiIdempotent)")
