package org.atomicode.inf.middleware.redis.lock;
...
import org.atomicode.inf.common.util.SpElUtil;
import org.atomicode.inf.common.util.SpringAspectUtil;
...
public class ApiIdempotentAspect {
     ...
     * 接口幂等切面
     */
    @Around("@annotation(org.atomicode.inf.middleware.redis.lock.ApiIdempotent)||" +
            "@within(org.atomicode.inf.middleware.redis.lock.ApiIdempotent)")
